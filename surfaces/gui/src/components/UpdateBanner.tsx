...
export function UpdateBanner() {
  ...
  return (
    ...
    >
      <div className="text-[13px] font-semibold">{t("settings:update.available")}</div>
      <div className="text-[12px] text-muted mt-0.5">
        {t("settings:update.ready", { version: update.version })}
      </div>
      {phase === "error" && (
      ...
      <div className="flex items-center gap-2 mt-2.5">
        ...
        >
          {busy ? t("settings:update.downloading") : t("settings:update.restart")}
        </button>
        <button
