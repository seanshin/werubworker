          ...
          <div className={"mlist-row" + (checked(id) ? "" : " off")} key={id}>
            <label className="mlist-main">
              <input
                ...
                checked={checked(id)}
                disabled={isDefault}
                title={isDefault ? t("settings:manageTabs.defaultAlwaysShown") : undefined}
            ...
            {isDefault ? (
              <span className="mlist-default">{t("settings:manageTabs.default")}</span>
            ) : (
              <button className="mlist-make" onClick={() => makeDefault(id)}>
                {t("settings:manageTabs.makeDefault")}
              </button>
            )}
          </div>
        );
      ...
      <div className="mlist-add">
        {families && (
          <select
            ...
            aria-label={t("settings:modelChecklist.modelFamily")}
        ...
        <input
          placeholder={t("settings:modelChecklist.addAnother")}
          value={draft}
          spellCheck={false}
          autoComplete="off"
