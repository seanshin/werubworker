...
// Persona naming: the product is "WeruBWorker"; the personas are a "Coworker" family — Coworker
...
// API + tests keep "WeruBWorker" / "Ops Coworker"); this is purely the display layer.
