...
uploads):
    ...
    WeruBWorker-macos-arm64.app.tar.gz(.sig)   -> platforms["darwin-aarch64"]
    WeruBWorker-macos-x64.app.tar.gz(.sig)     -> platforms["darwin-x86_64"]
    WeruBWorker-windows-setup.exe(.sig)        -> platforms["windows-x86_64"]
...
The desktop app finds this file through https://download.werubworker.com/latest.json
...
ARTIFACTS = {
    "WeruBWorker-macos-arm64.app.tar.gz": "darwin-aarch64",
    "WeruBWorker-macos-x64.app.tar.gz": "darwin-x86_64",
    "WeruBWorker-windows-setup.exe": "windows-x86_64",
}
